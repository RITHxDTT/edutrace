...
export default function AssessmentCard({
    ...
    return (
        <div
            className={`relative w-fit min-w-[300px] min-h-[328px]`}>
            <BackgroundCard />
            <div className="relative z-10 p-6 flex flex-col h-[328px]">

                <div>
                    <div className="h-full w-full flex flex-col justify-between p-3 sm:p-4 md:p-5">
                        ...
                        {/* Middle content */}
                        <p className="text-xs sm:text-sm md:text-base text-primary leading-snug line-clamp-3 sm:line-clamp-2 md:line-clamp-3">
                            {description}
                        </p>

                        {/* Bottom rubric preview */}
                        <div className="text-[10px] sm:text-xs text-gray-500 border-t pt-2 mt-2">
                            {gradingRubric}
                        </div>
                    </div>
                </div>
