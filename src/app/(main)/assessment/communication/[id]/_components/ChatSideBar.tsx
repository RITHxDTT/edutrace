    ...
    <div className="w-[340px] bg-white border border-slate-200 rounded-2xl flex flex-col h-full shadow-sm shrink-0">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 min-h-0">
        {messages.map((msg) => {
          ...
          return (
            <div key={msg.chatMessageId} className="flex gap-3 items-start">
              <img 
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-slate-600 mt-1 break-words bg-slate-50 p-2.5 rounded-xl border border-slate-100/50">
                  {msg.content}
                </p>
              </div>
            </div>
