...
export default function ConnectedSection() {
  return (
    <section className="w-full bg-bgapp py-16 sm:py-20 flex flex-col items-center text-center px-5 sm:px-8">
        ...
        <span className="text-[#20B1E6] font-bold">
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              ...
              stroke="#20B1E6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"
            />
            <path
      ...
      <p className="text-base sm:text-lg md:text-[24px] text-textDisable mb-2 max-w-2xl">
        Manage your tasks, get timely notifications, and stay connected with
        your instructors
      </p>
      <h2 className="font-medium text-2xl sm:text-3xl md:text-[48px] bg-accent-linear-purple bg-clip-text text-transparent">
        Everything connected to the task
      </h2>

      {/* Cards — 2-1-2 on desktop, stacked grid on mobile */}
      <div className="flex flex-col gap-5 w-full max-w-5xl mt-10 sm:mt-14">
        {/* Row 1 */}
